 ...
 * Post-condizione: 'dueNegDuePari' è pari ad 1 nel caso in cui ogni tripla di interi consecutivi nella 
 * sequenza contiene almeno due interi negativi ed almeno due pari, è pari a 0 altrimenti
...
{
	int dueNegDuePari=1;		// variabile di universalità
